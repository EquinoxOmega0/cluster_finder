...
OPEN(50,file='catalogues/fi_info.txt')
WRITE(50,*) final_dens
WRITE(50,*) Vol_fi
 CLOSE(50)

OPEN(50,file='catalogues/fi_regions.txt')
 DO i=1,n_all
IF (active(i)) THEN
...
END DO
 ...
 OPEN(50,file='final_catalogues/fi_regions_basic_lcdm.txt')
 DO i=1,n_all
IF (active(i)) THEN
...
OPEN(50,file='catalogues/fi_info_fullmass.txt')
WRITE(50,*) 1.D0
WRITE(50,*) Vol_fi
 CLOSE(50)
...
OPEN(50,file='catalogues/fi_regions_fullmass.txt')
 DO i=1,n_all
IF (active(i)) THEN
WRITE(50,*) ra_fi(i),dec_fi(i),cdist_fi(i),px(i),py(i),pz(i),LOG10(mass(i)),mass_err(i),rad(i),rad_err(i)
END IF
END DO
 ...
 OPEN(50,file='final_catalogues/fi_regions_fullmass_lcdm.txt')
 DO i=1,n_all
IF (active(i)) THEN
WRITE(50,"(2F14.8,4F10.3,4F10.5)") ra_fi(i),dec_fi(i),cdist_fi(i),px(i),py(i),pz(i),&
LOG10(mass(i)),mass_err(i),rad(i),rad_err(i)
