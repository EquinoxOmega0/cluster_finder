...
double precision, dimension(1:10,1:10) :: S_function
...
!   0.59455486222595466       0.61597383690106011            

! s_used=0.023D0
! lum_used=1.D0
lum_used=0.82229448348690837

DO e=1,10
DO ee=1,10

b_used=DBLE(e)/10.D0
R_used=DBLE(ee)/10.D0
...
! S_tot_av=(S_array(4)+S_array(5))/2.D0
 ...
 OPEN(50,file='grid_rough_SDSS.txt')
DO e=0,10
DO ee=0,10
b_used=DBLE(e)/10.D0
R_used=DBLE(ee)/10.D0
...
OPEN(50,file='gridquality_'//TRIM(apx)//'/binclusterfof_'//TRIM(nm)//'_'//TRIM(ecs)//'.txt')
DO i=1,102
...
OPEN(50,file='gridquality_'//TRIM(apx)//'/binclustermock_'//TRIM(nm)//'_'//TRIM(ecs)//'.txt')
DO i=1,102
...
!   CLOSE(50)
 ...
 OPEN(50,file='gridquality_'//TRIM(apx)//'/n_g_multi_'//TRIM(nm)//'_'//TRIM(ecs)//'.txt')
...
OPEN(50,file='gridquality_'//TRIM(apx)//'/group_cost_function_'//TRIM(nm)//'_'//TRIM(ecs)//'.txt')
