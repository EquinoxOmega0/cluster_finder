...
set palette defined ( 0 '#FFFFFF',\
                      ...
                      2 '#ffff00',\
                      3 '#00ff00')
p 'test.dat' with image, '2MRS_neighbours_1overlap.txt' pt 1 ps 1 lt 3  notitle
...
set palette defined ( 0 '#FFFFFF',\
                      ...
                      2 '#ffff00',\
                      3 '#00ff00')
p 'test.dat' with image, '2MRS_neighbours_2overlap.txt' pt 1 ps 1 lt 3  notitle
...
set palette defined ( 0 '#FFFFFF',\
                      ...
                      2 '#ffff00',\
                      3 '#00ff00')
p 'test.dat' with image, '2MRS_neighbours_3overlap.txt' pt 1 ps 1 lt 3  notitle
